// ============================================================
//  ZOO ENRICHMENT LIBRARY — PROJECT DATA
...
//
//  TAGS — use exact strings from the lists below so filters
//  work correctly. You can add new tag values any time;
//  they will automatically appear in the filter bar.
//
//  tools        → matches the "Tools I have" filter (inclusive)
//  taxa         → animal group tags
//  behavior     → target enrichment behavior
//  complexity   → "Simple" | "Intermediate" | "Complex Kit"
//  files        → file types included in the download
//
